...
public class ViewProducts extends javax.swing.JFrame implements Node{
    ...
    public ViewProducts( EmployeeRole e) {
        initComponents();
        this.e=e;
        setData();
    ...
    private void setData(){
         ...
         for (Product product : e.getListOfProducts()) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Product Name", "Manufcaturer Name ", "Supplier Name ", "Quantity", "Price"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewProducts x= new ViewProducts(e);
                x.setVisible(true);
            }
        });
    }
